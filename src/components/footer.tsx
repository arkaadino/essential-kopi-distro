...
export function Footer() {
  const socialLinks = [
    { icon: Instagram, href: "https://instagram.com/hqessentialkopi", label: "Instagram" },
  ]
    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* Contact Info */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-amber-600">Kontak Kami</h3>
            <div className="space-y-3 text-sm">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <a
                    href="mailto:kopiessential@gmail.com"
                    className="text-gray-300 hover:text-amber-600 transition-colors"
                  >
                    kopiessential@gmail.com
                  </a>
                </div>
              </div>
            </div>
          ...
          {/* Quick Links & Hours */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-amber-600">Navigasi</h3>
            <div className="space-y-2 text-sm">
              ...
              <a href="#portfolio" className="block text-gray-300 hover:text-amber-600 transition-colors">
                Produk & Layanan
              </a>
              <a href="#gallery" className="block text-gray-300 hover:text-amber-600 transition-colors">
                Galeri
              </a>
              <a href="#testimonials" className="block text-gray-300 hover:text-amber-600 transition-colors">
                Testimoni
              </a>
            </div>
          ...
          <div className="space-y-6">
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-amber-600">Produk Kami</h3>
